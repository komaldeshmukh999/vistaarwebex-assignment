  ...
  return (
    <div className="flex flex-col gap-10">
      ...
      <div className="text-center">
             <button className="bg-[#1F4A5C] hover:bg-[#2A5A6E] text-white font-semibold px-12 py-4 rounded-full transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 my-8">
            Explore
          </button>
